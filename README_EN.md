...
- **Core Packs**:
  - **Doll**: Adorable creature plushies obtainable via a gacha machine.  
    - **Credits**: Plushies representing early supporters.
  - **Cookery**: Decorative kitchenware and picnic items.
  - **Bar**: Currently includes a display board; **this theme will be significantly expanded soon**.
  - **Chinese**: Classic Chinese-style decorations, such as lanterns and blessing belts.
  - **Lab**: Indoor decorations suitable for studies or laboratories.
  - **Holiday**: Festive and vacation-themed decor, including string lights and beach umbrellas.
  - **Road**: Outdoor street decorations like traffic cones and warning signs.

- **Extension Packs**:
  - **Doll Plus**: Adds unique sound effects and particle effects to each plushie, along with additional interactions. Requires the Doll core pack.
  - **Cookery Plus**: Introduces a stove and cooking mechanics, along with many new cookable food items.
