...
#【doll_2】烈焰人
data modify storage dc:index input.doll_2 set value {loot_table:"kaleidoscope:doll/doll_2",template:"doll"}
data modify storage dc:index keylist append value "doll_2"

#【doll_3】末影人
data modify storage dc:index input.doll_3 set value {loot_table:"kaleidoscope:doll/doll_3",template:"doll"}
...
#【doll_12】恶魂
data modify storage dc:index input.doll_12 set value {loot_table:"kaleidoscope:doll/doll_12",template:"doll"}
data modify storage dc:index keylist append value "doll_12"

#【doll_13】远古守卫者
data modify storage dc:index input.doll_13 set value {loot_table:"kaleidoscope:doll/doll_13",template:"doll"}
data modify storage dc:index keylist append value "doll_13"

#【doll_14】守卫者
data modify storage dc:index input.doll_14 set value {loot_table:"kaleidoscope:doll/doll_14",template:"doll"}
...
#【doll_21】蠹虫+末影螨
data modify storage dc:index input.doll_21 set value {loot_table:"kaleidoscope:doll/doll_21",template:"doll"}
